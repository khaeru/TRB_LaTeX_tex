\documentclass[biblatex,nocompat]{trbunofficial}
...
\addbibresource{trb_template.bib}
...
The \textcite{TRBGuide} has unique and somewhat arbitrary requirements for
...
are defined as outlined by the \textcite{TRBGuide}
...
be in your document folder. A new command is specified, \verb1\textcite{}1 which
will print the authors and the number of the reference in the order in which it
is supplied. Note that \verb1\textcite{}1 prints both the author names and the
...
\textcite{Bierlaire2003} and \textcite{Bierlaire2008} or to papers like those
written by \textcite{Garrow2009} and \textcite{Koppelman2005}. You can even go
back and refer to Biog\'eme by \textcite{Bierlaire2008} a second time. You can
